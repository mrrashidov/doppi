<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-10" @close="handleActions('close')">
      <TransitionChild
        as="template"
...
defineProps({
  ...
  button: {
    type: Object as PropType<{ confirm: string; cancel: string }>,
    required: true,
  },
});
const emits = defineEmits(["modal"]);
const handleActions = (action: string) => emits("modal", action);
</script>
